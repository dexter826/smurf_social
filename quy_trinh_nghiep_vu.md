...
3. ## **_Xóa ảnh và Xem thống kê_**

Người dùng cũng có thể xóa ảnh đại diện hoặc ảnh bìa hiện tại để trở về trạng thái mặc định. Ngoài ra, trên trang cá nhân của mỗi người dùng, hệ thống tự động tổng hợp và hiển thị các số liệu thống kê cơ bản bao gồm: **Số lượng bạn bè** và **Số lượng bài viết** (chỉ đếm các bài viết mà người xem có quyền truy cập).

4. ## **_Cài đặt và Bảo mât_**

Người dùng có thể cá nhân hóa trải nghiệm thông qua mục Cài đặt:
- **Giao diện:** Chuyển đổi linh hoạt giữa chế độ Sáng (Light) và Tối (Dark) để phù hợp với môi trường sử dụng.
- **Bảo mật:** Cho phép người dùng chủ động thay đổi mật khẩu đăng nhập bằng cách xác nhận mật khẩu hiện tại và nhập mật khẩu mới.
- **Quản lý chặn:** Xem danh sách những người dùng đã bị chặn và thực hiện bỏ chặn nếu cần.
![][image2]
...
4. ## **_Tìm kiếm người dùng đích danh_**

Để đảm bảo tính riêng tư, hệ thống không cho phép tìm kiếm người lạ theo tên gợi ý rộng rãi. Người dùng phải nhập **chính xác địa chỉ email** của người khác vào ô tìm kiếm. Nếu hệ thống tìm thấy kết quả khớp hoàn toàn, người dùng sẽ được chuyển hướng trực tiếp đến trang cá nhân của người đó để thực hiện các tương tác tiếp theo (Kết bạn, Nhắn tin, Xem nội dung).

5. ## **_Quản lý Danh bạ tập trung_**

Người dùng có một trang "Danh bạ" chuyên dụng để thực hiện các thao tác quản lý mối quan hệ một cách nhanh chóng:
- **Tất cả bạn bè:** Hiển thị danh sách bạn bè hiện có, hỗ trợ tìm kiếm nhanh theo tên trong danh bạ và sắp xếp theo thứ tự bảng chữ cái (A-Z/Z-A).
- **Lời mời kết bạn:** Tập trung các yêu cầu kết bạn đang chờ phản hồi.
- **Lời mời đã gửi:** Theo dõi các yêu cầu kết bạn mà bản thân đã gửi đi để có thể thu hồi nếu cần.
